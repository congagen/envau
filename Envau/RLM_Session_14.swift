...
class RLM_Session_14: Object {
    
    let projectData = List<RLM_BeaconData>()
    var activeLayers = List<RLM_Layer_12>()
    
    var sessionBeacons = List<RLM_BeaconData>()
    var beaconsInRange = List<RLM_BeaconData>()
    
    @objc dynamic var trackingMode = 1
    @objc dynamic var playbackMode = 1
    @objc dynamic var locationUpdateMode = 1
    
    @objc dynamic var sequencerMode = 1
    @objc dynamic var sequencerType = 2
    @objc dynamic var sequencerSpeed = 120
    
    @objc dynamic var playbackPaused = false
    
    @objc dynamic var holdNotes = true
    @objc dynamic var ampFromDistance = true
    @objc dynamic var avgVeloFromDuplicateNotes = false
    ...
    @objc dynamic var masterVolume = 1.0
    
    @objc dynamic var audioFxAmoutA:Double = 1000.0
    @objc dynamic var audioFxAmoutB:Double = 0.3
    @objc dynamic var audioFxAmoutC:Double = 0.3
    @objc dynamic var audioFxAmoutD:Double = 0.3
    @objc dynamic var audioFxAmoutE:Double = 0.3
    
    @objc dynamic var dryWetFxMix = 0.2
    
    @objc dynamic var reverbFeedback: Double = 0.8
    @objc dynamic var reverbCutoff: Double = 4000.0
    @objc dynamic var reverbAmount: Double = 0.5
